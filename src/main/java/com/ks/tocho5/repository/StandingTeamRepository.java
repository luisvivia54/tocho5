...
public interface StandingTeamRepository extends JpaRepository<StandingTeamModel, Integer> {
  ...
  /**
   * Versión "safe" de filtrado: por ahora ignora los filtros y reutiliza findAllWithTeam(),
   * solo para que el contexto arranque sin que Hibernate valide un JPQL raro.
   * Más adelante, cuando tengas mapeada la liga en StandingTeamModel, aquí metemos
   * un @Query con filtros reales.
   */
